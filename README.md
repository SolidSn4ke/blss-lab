...
| POST | `/housings` | Запрос на добавление жилья |
| POST | `/housings/{id}/moderation` | Модерация запроса на добавления жилья с указанным id |
| GET | `/housings` | Получить список жилья |
| POST | `/bookings` | Запрос на бронирование жилья |
| POST | `/bookings/{id}/moderation` | Модерация запроса на бронирования жилья с указанным id |
| GET | `/bookings` | Получить список запросов на бронирование |
| PATCH | `/users/{username}` | Обновить данные о пользователе с ником username |
| DELETE | `/users/{username}` | Удалить пользователя с ником username |
| PATCH | `/bookings/{id}` | Обновить данные о бронировании с указанным id |
| DELETE | `/bookings/{id}` | Удалить запрос на бронирование с указанным id |
| PATCH | `/housings/{id}` | Обновить данные о жилье с указанным id |
| DELETE | `/housings/{id}` | Удалить жилье с указанным id |
